...
| Module           | File                                                         | Scope                                                                            |
| ---------------- | ------------------------------------------------------------ | -------------------------------------------------------------------------------- |
| Admin Panel      | [modules/admin.md](./modules/admin.md)                       | Dashboard, document templates, request creation, merged profiles/submissions Users page, and settings (with merged logs) |
